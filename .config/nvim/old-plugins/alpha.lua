local function alphaconfig(_, _)
  ...
  local config = function()
    ...
    vim.api.nvim_set_hl(0, "AlphaHeader", { fg = '#fabd2f', bold=true })
    ...
    -- local header = {
    --     type = "terminal",
    --     command = "cat | $HOME/.config/nvim/thisisfine.sh",
    --     height = 25,
    --     width =  45,
    --     opts = {
    --         redraw = true,
    ...
    local buttons = {
      ...
      val = {
        ...
        dashboard.button("r", "  Recent files"   , ":RecentFiles<CR>"),
        dashboard.button("d o", "  Open diffview" , ":DiffviewOpen<CR>"),
        dashboard.button("f f", "󰈞  Find file", "<cmd>FindFiles<CR>"),
        dashboard.button("f g", "󰊄  Find text", "<cmd>FindText<CR>"),
...
return {
  {'goolord/alpha-nvim', config = alphaconfig}, -- dashboard
}
