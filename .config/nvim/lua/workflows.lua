...
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd /home/jfelmeden/notes<cr>")
--
...
vim.keymap.set("n", "<leader>os", ":Telescope find_files search_dirs={\"/home/jfelmeden/notes\"}<cr>")
vim.keymap.set("n", "<leader>oz", ":Telescope live_grep search_dirs={\"/home/jfelmeden/notes\"}<cr>")
--
...
vim.keymap.set("n", "<leader>ok", ":!mv '%:p' /home/jfelmeden/notes/zettelkasten<cr>:bd<cr>")
